...
The cross-references are stable: we cite \Cref{tab:bridges} for bridge losses and reuse platform and relaxation identifiers defined in earlier sections. All logarithms are base 2 ($\log_{2}$). Post-0.8.71 residual-risk $\approx$ 97--98\%; 0.9.x adds portability/polish; 1.0 unifies.\;{\small\texttt{(Post-0.8.71 residual-risk \~\ 97--98\%)}}