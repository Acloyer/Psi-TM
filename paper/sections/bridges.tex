% v0.9.3 Bridges: Machine↔Tree and Tree↔Circuit with explicit losses, plus composition corollary
\section{Bridges with Explicit Losses (v0.9.3)}
...
\begin{theorem}[Bridge: Machine$\leftrightarrow$Tree]\label{thm:bridge-machine-tree}
...
\begin{theorem}[Bridge: Tree$\leftrightarrow$Circuit]\label{thm:bridge-tree-circuit}
