% Stepwise budget accumulation and generalized anti-simulation (tooling-friendly labels)

\begin{lemma}[Stepwise budget accumulation]\label{lem:step-budget}
...
\begin{theorem}[Generalized Anti-Simulation]\label{thm:antisim}
