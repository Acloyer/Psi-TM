...
% Reproducibility & Artifact Summary (v0.8.7)
\input{paper/section-release-overview}
...
This paper is organized to first freeze the model and the $\iota$ interface, then present lower-bound tools, hierarchy results, and conservative barrier statements. For a high-level overview and acceptance criteria, see Section~\ref{sec:repro}.
